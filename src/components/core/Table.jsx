...
export default function CoursesTable({ courses, setCourses ,tableLoading,setTableLoading}) {
...
{console.log(courses)
  ...
  return (
    <div id="maintable">
    { 
      tableLoading?(<div className="spinner"></div>):
      (<>
      <Table className="ct-table">
        ...
        <Tbody>
          {tableLoading==false && courses?.length === 0 ? (
            <Tr>
